...
class PlayerProfileScreen extends StatefulWidget {
  ...
  PlayerProfileScreen({Key key, @required this.id}) : super(key: key);

  @override
  _PlayerProfileScreenState createState() => _PlayerProfileScreenState(this.id);
}
...
class _PlayerProfileScreenState extends State<PlayerProfileScreen> {
  ...
  _PlayerProfileScreenState(this.id);
