...
class TeamGalleryFragment extends StatefulWidget {

  @override
  _TeamGalleryFragmentState createState() => _TeamGalleryFragmentState();
}

class _TeamGalleryFragmentState extends State<TeamGalleryFragment> {
