...
class _HomeScreenState extends State<HomeScreen> {
  ...
  DatabaseReference users_tokens =
    ...
    return Scaffold(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Align(
                ...
                child: Container(
                  child: (player_status != null && player_status == "Guest")
                      ? Column(
                          children: <Widget>[
                            Divider(),
                            InkWell(
                      ...
                      : (player_status != null && player_status == "Player")
                          ? Column(
                              children: <Widget>[
                                Divider(),
                                InkWell(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Badge(
              child: ImageIcon(new AssetImage("assets/request.png")),
