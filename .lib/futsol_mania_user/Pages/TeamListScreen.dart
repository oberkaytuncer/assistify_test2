...
class _TeamListScreenState extends State<TeamListScreen> {
  ...
  DatabaseReference playerDb = FirebaseDatabase.instance.reference().child("players");
  ...
  void initState() {
    ...
    playerDb.once().then((DataSnapshot datasnapshot){
      if(datasnapshot==null || datasnapshot.value==null) {
      ...
      else
        {
          ...
          for (var key in keys) {
            ...
            String player_phone= "";
            player_id = data[key]['user_id'];
            player_age = data[key]['age'];
            player_position = data[key]['position'];
              ...
              if(userDataSnap.value==null)
                ...
                else
                {
                  setState(() {
                    ...
                    Player player = Player(player_name, player_id, player_position, player_age, player_city, player_picture, player_phone);
                    players.add(player);
                  });
